...
def main():
    ...
    with zipfile.ZipFile(args.bundle) as bundle, zipfile.ZipFile(build/'seed_library.zip', 'w', zipfile.ZIP_DEFLATED) as seed:
    ...
    summary = {**release, 'source': str(args.source.resolve()), 'data_bundle': str(args.bundle.resolve()),
               'data_bundle_sha256': hashlib.sha256(args.bundle.read_bytes()).hexdigest(),
